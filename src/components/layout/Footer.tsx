        ...
        <div className="container mx-auto px-4">
            ...
            <div className="flex-1">
                ...
                <p className="text-sm leading-relaxed max-w-lg bg-(--bg-sub)/40 p-2 rounded-xl backdrop-blur-sm">
                    Movies - Trang web xem phim trực tuyến miễn phí chất lượng cao với giao diện thân thiện, tốc độ tải trang nhanh, cùng kho phim với hơn 30.000+ phim mới, phim hay, luôn cập nhật phim nhanh, hứa hẹn sẽ đem lại phút giây giải trí tuyệt vời cho bạn.
                </p>
            </div>
